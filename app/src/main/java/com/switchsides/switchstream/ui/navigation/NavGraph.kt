...
import com.switchsides.switchstream.SwitchStreamApp
import com.switchsides.switchstream.ui.components.MainScaffold
import com.switchsides.switchstream.ui.screens.connect.ConnectScreen
import com.switchsides.switchstream.ui.screens.connect.ConnectViewModel
import com.switchsides.switchstream.ui.screens.detail.DetailScreen
import com.switchsides.switchstream.ui.screens.detail.DetailViewModel
import com.switchsides.switchstream.ui.screens.favorites.FavoritesScreen
import com.switchsides.switchstream.ui.screens.favorites.FavoritesViewModel
import com.switchsides.switchstream.ui.screens.history.HistoryScreen
import com.switchsides.switchstream.ui.screens.history.HistoryViewModel
import com.switchsides.switchstream.ui.screens.home.HomeScreen
import com.switchsides.switchstream.ui.screens.home.HomeViewModel
import com.switchsides.switchstream.ui.screens.library.LibraryScreen
import com.switchsides.switchstream.ui.screens.library.LibraryViewModel
import com.switchsides.switchstream.ui.screens.login.LoginScreen
import com.switchsides.switchstream.ui.screens.login.LoginViewModel
import com.switchsides.switchstream.ui.screens.player.PlayerScreen
import com.switchsides.switchstream.ui.screens.player.PlayerViewModel
import com.switchsides.switchstream.ui.screens.search.SearchScreen
import com.switchsides.switchstream.ui.screens.search.SearchViewModel
import com.switchsides.switchstream.ui.screens.settings.SettingsScreen
import com.switchsides.switchstream.ui.screens.settings.SettingsViewModel
...
fun NavGraph(startDestination: String, deepLinkRoute: String? = null) {
    ...
    NavHost(
        ...
        composable(
            ...
            val libraryId = backStackEntry.arguments?.getString("libraryId") ?: ""
            val vm = viewModel {
                com.switchsides.switchstream.ui.screens.genre.GenreViewModel(
                    libraryRepo = container.createLibraryRepository(),
                    imageRepo = container.createImageRepository(),
                    libraryId = UUID.fromString(libraryId)
                )
            }
            com.switchsides.switchstream.ui.screens.genre.GenreScreen(
                viewModel = vm,
                onItemClick = { itemId ->
                    navController.navigate(Screen.Detail.createRoute(itemId))
                }
        ...
        composable(
            ...
            val vm = viewModel {
                com.switchsides.switchstream.ui.screens.person.PersonViewModel(
                    libraryRepo = container.createLibraryRepository(),
                    imageRepo = container.createImageRepository(),
            ...
            com.switchsides.switchstream.ui.screens.person.PersonScreen(
                viewModel = vm,
                onItemClick = { itemId ->
                    navController.navigate(Screen.Detail.createRoute(itemId))
                }
        ...
        composable(
            ...
            DrawerWrappedScreen(
                ...
                com.switchsides.switchstream.ui.screens.downloads.DownloadsScreen(
                    viewModel = vm,
                    onItemClick = { itemId ->
                        navController.navigate(Screen.Detail.createRoute(itemId))
                    }
        ...
        composable(
            ...
            com.switchsides.switchstream.ui.screens.users.UsersScreen(
        ...
        composable(
            ...
            val pipSetting by container.settingsManager.settings.collectAsState(
                initial = com.switchsides.switchstream.data.PlaybackSettings()
            )
...
private fun DrawerWrappedScreen(
    ...
    container: com.switchsides.switchstream.di.AppContainer,
